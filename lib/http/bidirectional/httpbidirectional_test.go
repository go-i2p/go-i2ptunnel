...
// TestHTTPBidirectionalSetOptionsTarget verifies that SetOptions correctly
// updates the target address and that the change is reflected in Options().
...
// TestHTTPBidirectionalSetOptionsTargetValidation verifies that invalid target
