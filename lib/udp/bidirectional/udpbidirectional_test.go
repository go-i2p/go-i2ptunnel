...
// TestUDPBidirectionalSetOptionsTarget verifies that SetOptions correctly
...
func TestUDPBidirectionalSetOptionsTarget(t *testing.T) {
...
// TestUDPBidirectionalSetOptionsTargetValidation verifies that invalid target
// addresses are rejected by SetOptions.
func TestUDPBidirectionalSetOptionsTargetValidation(t *testing.T) {
	addr, _ := net.ResolveUDPAddr("udp", "127.0.0.1:8080")
	tunnel := &UDPBidirectional{
		TunnelConfig: i2pconv.TunnelConfig{
			Name:      "ub-validate",
